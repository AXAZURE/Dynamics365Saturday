...
namespace Microsoft.Maker.Devices.Hx711
{
    public sealed class Hx711
    {
        ...
        private double coefficient = 2.03; // Coeficiente de conversión calculado.
        private int offset; // Calibrado - Marca de la báscula vacía
        ...
        public Hx711(int clockPinNumber, int dataPinNumber, int offset)
        {
        ...
        public int Grams
        {
            ...
            get
            {
                ...
                lock (this)
                {
                    ...
                    int grams = ReadData() / 1000;
                    int ret = Convert.ToInt16((grams - offset) / coefficient);
                    return grams;
                }
            }
        }
